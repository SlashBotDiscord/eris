...
/**
 * Represents an interaction. You also probably want to look at CommandInteraction, ComponentInteraction, AutocompleteInteraction, and ModalSubmitInteraction.
...
class Interaction extends Base {
    ...
    static from(data, client) {
        ...
        client.emit(
            "warn",
            new Error(
                `Unknown interaction type: ${data.type}\n${JSON.stringify(
                    data,
                    null,
                    2
                )}`
