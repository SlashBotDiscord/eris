...
class TextChannel extends GuildChannel {
    constructor(data, client, messageLimit) {
        ...
        this.messages = new Collection(
            Message,
            messageLimit == null ? client.options.messageLimit : messageLimit
        );
    ...
    addMessageReaction(messageID, reaction) {
        return this.client.addMessageReaction.call(
            this.client,
            this.id,
            messageID,
            reaction
    ...
    createInvite(options, reason) {
        return this.client.createChannelInvite.call(
            this.client,
            this.id,
            options,
            reason
    ...
    createMessage(content, file) {
        return this.client.createMessage.call(
            this.client,
            this.id,
            content,
            file
