...
class Guild extends Base {
    constructor(data, client) {
        super(data.id);
        this._client = client;
        this.shard = client.shards.get(
            client.guildShardMap[this.id] ||
                Base.getDiscordEpoch(data.id) % client.options.maxShards ||
                0
        );
            ...
            if (!client.bot) {
                ...
                for (const voiceState of data.voice_states) {
                    ...
                    if (
                        ...
                        voiceState.id === client.user.id &&
                        !client.voiceConnections.get(this.id)
                    ) {
                        process.nextTick(() =>
                            this._client.joinVoiceChannel(voiceState.channel_id)
                        );
                    }
                }
            }
    ...
    update(data) {
        ...
        if (data.welcome_screen !== undefined) {
            this.welcomeScreen = {
                ...
                welcomeChannels:
                    data.welcome_screen.welcome_channels &&
                    data.welcome_screen.welcome_channels.map((c) => {
                        return {
                            channelID: c.channel,
    ...
    get bannerURL() {
        return this.banner
            ? this._client._formatImage(Endpoints.BANNER(this.id, this.banner))
            : null;
    }

    get iconURL() {
        return this.icon
            ? this._client._formatImage(
    ...
    get splashURL() {
        return this.splash
            ? this._client._formatImage(
                  Endpoints.GUILD_SPLASH(this.id, this.splash)
              )
            : null;
    }
    ...
    get discoverySplashURL() {
        return this.discoverySplash
            ? this._client._formatImage(
                  Endpoints.GUILD_DISCOVERY_SPLASH(
                      this.id,
    ...
    addDiscoverySubcategory(categoryID, reason) {
        return this._client.addGuildDiscoverySubcategory.call(
            this._client,
            this.id,
            categoryID,
            reason
    ...
    addMemberRole(memberID, roleID, reason) {
        return this._client.addGuildMemberRole.call(
            this._client,
            this.id,
            memberID,
            roleID,
    ...
    banMember(userID, deleteMessageDays, reason) {
        return this._client.banGuildMember.call(
            this._client,
            this.id,
            userID,
            deleteMessageDays,
    ...
    bulkEditCommandPermissions(permissions) {
        return this._client.bulkEditCommandPermissions.call(
            this._client,
            this.id,
            permissions
        );
    ...
    bulkEditCommands(commands) {
        return this._client.bulkEditGuildCommands.call(
            this._client,
            this.id,
            commands
        );
    ...
    createChannel(name, type, reason, options) {
        return this._client.createChannel.call(
            this._client,
            this.id,
            name,
            type,
    ...
    createCommand(command) {
        return this._client.createGuildCommand.call(
            this._client,
            this.id,
            command
        );
    ...
    createEmoji(options, reason) {
        return this._client.createGuildEmoji.call(
            this._client,
            this.id,
            options,
            reason
    ...
    createRole(options, reason) {
        return this._client.createRole.call(
            this._client,
            this.id,
            options,
            reason
    ...
    createSticker(options, reason) {
        return this._client.createGuildSticker.call(
            this._client,
            this.id,
            options,
            reason
    ...
    createTemplate(name, description) {
        return this._client.createGuildTemplate.call(
            this._client,
            this.id,
            name,
            description
    ...
    deleteCommand(commandID) {
        return this._client.deleteGuildCommand.call(
            this._client,
            this.id,
            commandID
        );
    ...
    deleteEmoji(emojiID, reason) {
        return this._client.deleteGuildEmoji.call(
            this._client,
            this.id,
            emojiID,
            reason
    ...
    deleteIntegration(integrationID) {
        return this._client.deleteGuildIntegration.call(
            this._client,
            this.id,
            integrationID
        );
    ...
    deleteRole(roleID, reason) {
        return this._client.deleteRole.call(
            this._client,
            this.id,
            roleID,
            reason
    ...
    deleteSticker(stickerID, reason) {
        return this._client.deleteGuildSticker.call(
            this._client,
            this.id,
            stickerID,
            reason
     ...
     */
    deleteTemplate(code) {
        return this._client.deleteGuildTemplate.call(
            this._client,
            this.id,
            code
        );
    ...
    dynamicBannerURL(format, size) {
        return this.banner
            ? this._client._formatImage(
                  Endpoints.BANNER(this.id, this.banner),
                  format,
                  size
              )
            : null;
     ...
     */
    edit(options, reason) {
        return this._client.editGuild.call(
            this._client,
            this.id,
            options,
            reason
    ...
    editChannelPositions(channelPositions, reason) {
        return this._client.editGuildChannelPositions.call(
            this._client,
            this.id,
            channelPositions,
            reason
    ...
    editCommand(commandID, commands) {
        return this._client.editGuildCommand.call(
            this._client,
            this.id,
            commandID,
            commands
    ...
    editCommandPermissions(commandID, permissions) {
        return this._client.getCommandPermissions.call(
            this._client,
            this.id,
            commandID,
            permissions
    ...
    editDiscovery(options) {
        return this._client.editGuildDiscovery.call(
            this._client,
            this.id,
            options
        );
    ...
    editEmoji(emojiID, options, reason) {
        return this._client.editGuildEmoji.call(
            this._client,
            this.id,
            emojiID,
            options,
    ...
    editIntegration(integrationID, options) {
        return this._client.editGuildIntegration.call(
            this._client,
            this.id,
            integrationID,
            options
    ...
    editMember(memberID, options, reason) {
        return this._client.editGuildMember.call(
            this._client,
            this.id,
            memberID,
            options,
    ...
    editRole(roleID, options, reason) {
        return this._client.editRole.call(
            this._client,
            this.id,
            roleID,
            options,
    ...
    editSticker(stickerID, options, reason) {
        return this._client.editGuildSticker.call(
            this._client,
            this.id,
            stickerID,
            options,
    ...
    editTemplate(code, options) {
        return this._client.editGuildTemplate.call(
            this._client,
            this.id,
            code,
            options
    ...
    editVoiceState(options, userID) {
        return this._client.editGuildVoiceState.call(
            this._client,
            this.id,
            options,
            userID
    ...
    editWelcomeScreen(options) {
        return this._client.editGuildWelcomeScreen.call(
            this._client,
            this.id,
            options
        );
     ...
     */
    editWidget(options) {
        return this._client.editGuildWidget.call(
            this._client,
            this.id,
            options
        );
     ...
     */
    getAuditLog(options) {
        return this._client.getGuildAuditLog.call(
            this._client,
            this.id,
            options
        );
    ...
    getCommand(commandID) {
        return this._client.getGuildCommand.call(
            this._client,
            this.id,
            commandID
        );
    ...
    getGuildCommandPermissions() {
        return this._client.getGuildCommandPermissions.call(
            this._client,
            this.id
        );
    }
    ...
    getRESTEmoji(emojiID) {
        return this._client.getRESTGuildEmoji.call(
            this._client,
            this.id,
            emojiID
        );
    ...
    getRESTEvent(eventID) {
        return this._client.getRESTGuildEvent.call(
            this._client,
            this.id,
            eventID
        );
    ...
    getRESTMember(memberID) {
        return this._client.getRESTGuildMember.call(
            this._client,
            this.id,
            memberID
        );
    ...
    getRESTMembers(options, after) {
        return this._client.getRESTGuildMembers.call(
            this._client,
            this.id,
            options,
            after
    ...
    getRESTSticker(stickerID) {
        return this._client.getRESTGuildSticker.call(
            this._client,
            this.id,
            stickerID
        );
    ...
    kickMember(userID, reason) {
        return this._client.kickGuildMember.call(
            this._client,
            this.id,
            userID,
            reason
    ...
    listEvents(withUserCount) {
        return this._client.listGuildEvents.call(
            this._client,
            this.id,
            withUserCount
        );
    ...
    listEventUsers(eventID) {
        return this._client.listGuildEventUsers.call(
            this._client,
            this.id,
            eventID
        );
    ...
    removeMemberRole(memberID, roleID, reason) {
        return this._client.removeGuildMemberRole.call(
            this._client,
            this.id,
            memberID,
            roleID,
    ...
    searchMembers(query, limit) {
        return this._client.searchGuildMembers.call(
            this._client,
            this.id,
            query,
            limit
    ...
    syncIntegration(integrationID) {
        return this._client.syncGuildIntegration.call(
            this._client,
            this.id,
            integrationID
        );
    ...
    unbanMember(userID, reason) {
        return this._client.unbanGuildMember.call(
            this._client,
            this.id,
            userID,
            reason
