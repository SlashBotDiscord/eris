...
class Role extends Base {
    ...
    get iconURL() {
        return this.icon
            ? this.guild.shard.client._formatImage(
                  Endpoints.ROLE_ICON(this.id, this.icon)
              )
            : null;
    }
     ...
     */
    delete(reason) {
        return this.guild.shard.client.deleteRole.call(
     ...
     */
    edit(options, reason) {
        return this.guild.shard.client.editRole.call(
            this.guild.shard.client,
            this.guild.id,
            this.id,
            options,
    ...
    editPosition(position) {
        return this.guild.shard.client.editRolePosition.call(
            this.guild.shard.client,
            this.guild.id,
            this.id,
            position
