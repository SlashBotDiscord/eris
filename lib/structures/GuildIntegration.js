...
class GuildIntegration extends Base {
     ...
     */
    delete() {
        return this.guild.shard.client.deleteGuildIntegration.call(
     ...
     */
    edit(options) {
        return this.guild.shard.client.editGuildIntegration.call(
            this.guild.shard.client,
            this.guild.id,
            this.id,
            options
     ...
     */
    sync() {
        return this.guild.shard.client.syncGuildIntegration.call(
            this.guild.shard.client,
            this.guild.id,
            this.id
        );
