...
class GuildChannel extends Channel {
    ...
    deletePermission(overwriteID, reason) {
        return this.client.deleteChannelPermission.call(
            this.client,
            this.id,
            overwriteID,
            reason
     ...
     * @arg {String} [reason] The reason to be displayed in audit logs
     * @returns {Promise<CategoryChannel | TextChannel | VoiceChannel | NewsChannel | NewsThreadChannel | PrivateThreadChannel | PublicThreadChannel>}
     */
    edit(options, reason) {
        return this.client.editChannel.call(
            this.client,
            this.id,
            options,
            reason
    ...
    editPermission(overwriteID, allow, deny, type, reason) {
        return this.client.editChannelPermission.call(
            this.client,
            this.id,
            overwriteID,
            allow,
    ...
    editPosition(position, options) {
        return this.client.editChannelPosition.call(
            this.client,
            this.id,
            position,
            options
    ...
    permissionsOf(memberID) {
        const member =
            typeof memberID === "string"
                ? this.guild.members.get(memberID)
                : memberID;
        ...
        const channel =
            this instanceof ThreadChannel
                ? this.guild.channels.get(this.parentID)
                : this;
        let overwrite =
            channel && channel.permissionOverwrites.get(this.guild.id);
        if (overwrite) {
        ...
        for (const roleID of member.roles) {
            if (
                (overwrite =
                    channel && channel.permissionOverwrites.get(roleID))
            ) {
                deny |= overwrite.deny;
