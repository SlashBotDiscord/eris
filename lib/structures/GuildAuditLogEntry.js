...
class GuildAuditLogEntry extends Base {
    ...
    get target() {
        ...
        if (this.actionType < 10) {
            ...
            // Member
            if (
                this.actionType === AuditLogActions.MEMBER_MOVE ||
                this.actionType === AuditLogActions.MEMBER_DISCONNECT
            ) {
            ...
            return (
                this.guild &&
                this.guild.emojis.find((emoji) => emoji.id === this.targetID)
            );
        } else if (this.actionType < 80) {
            // Message
            return (
                this.guild && this.guild.shard.client.users.get(this.targetID)
            );
            ...
            return (
                this.guild &&
                this.guild.stickers.find(
                    (sticker) => sticker.id === this.targetID
                )
            );
        } else {
