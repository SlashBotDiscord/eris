...
class CommandInteraction extends Interaction {
    constructor(info, client) {
        ...
        if (info.data.resolved !== undefined) {
            ...
            if (info.data.resolved.users !== undefined) {
                ...
                Object.entries(info.data.resolved.users).forEach(
                    ([id, user]) => {
                        usermap.set(
                            id,
                            this._client.users.update(user, client)
                        );
                    }
                );
            ...
            if (info.data.resolved.members !== undefined) {
                ...
                Object.entries(info.data.resolved.members).forEach(
                    ([id, member]) => {
                        member.id = id;
                        member.user = { id };
                        if (this.channel.guild) {
                            ...
                            const guild = this._client.guilds.get(
                                info.guild_id
                            );
                            if (guild) {
                                membermap.set(
                                    id,
                                    guild.members.update(member, guild)
                                );
                            } else {
                                membermap.set(
                                    id,
                                    new Member(member, guild, this._client)
                                );
                            }
                        }
                    }
            ...
            if (info.data.resolved.roles !== undefined) {
                ...
                Object.entries(info.data.resolved.roles).forEach(
                    ([id, role]) => {
            ...
            if (info.data.resolved.channels !== undefined) {
                ...
                Object.entries(info.data.resolved.channels).forEach(
                    ([id, channel]) => {
            ...
            if (info.data.resolved.messages !== undefined) {
                ...
                Object.entries(info.data.resolved.messages).forEach(
                    ([id, message]) => {
    ...
    async createFollowup(content, file) {
        if (this.acknowledged === false) {
            throw new Error(
                "createFollowup cannot be used to acknowledge an interaction, please use acknowledge, createMessage, or defer first."
            );
        }
    ...
    async deleteMessage(messageID) {
        if (this.acknowledged === false) {
            throw new Error(
                "deleteMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, or defer first."
            );
        }
    ...
    async deleteOriginalMessage() {
        if (this.acknowledged === false) {
            throw new Error(
                "deleteOriginalMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, or defer first."
            );
        }
        return this._client.deleteWebhookMessage.call(
            this._client,
    ...
    async editMessage(messageID, content, file) {
        if (this.acknowledged === false) {
            throw new Error(
                "editMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, or defer first."
            );
        }
        if (content !== undefined) {
            if (typeof content !== "object" || content === null) {
    ...
    async editOriginalMessage(content, file) {
        if (this.acknowledged === false) {
            throw new Error(
                "editOriginalMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, or defer first."
            );
        }
        if (content !== undefined) {
            if (typeof content !== "object" || content === null) {
    ...
    async getOriginalMessage() {
        if (this.acknowledged === false) {
            throw new Error(
                "getOriginalMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, or defer first."
            );
        }
