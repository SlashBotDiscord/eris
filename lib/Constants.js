...
module.exports.GuildIntegrationTypes = ["twitch", "youtube", "discord"];
...
module.exports.ImageFormats = ["jpg", "jpeg", "png", "webp", "gif"];
...
Permissions.all =
    Permissions.allGuild | Permissions.allText | Permissions.allVoice;
